export const projectsData = [
  {
    ...
    images: ["/image/placeholder-project.png"],
    alts: ["Kisaan-Setu platform preview"],
  ...
  },
  {
    ...
    images: ["/image/placeholder-project.png"],
    alts: ["Connectly networking platform preview"],
  ...
  },
  {
    id: 3,
    title: "JobSearch.AI",
    technologies: "Next.js, React.js, Tailwind CSS, AI / LLMs, Node.js",
    description: [
      "Engineered an intelligent AI-powered job search platform helping candidates discover opportunities, analyze job requirements, and optimize application success.",
      "Integrated Generative AI and LLM workflows for automated candidate-role matching, resume insights, and personalized application feedback.",
      "Built a modern, responsive UI with real-time search filters, high performance, and seamless user experience."
    ],
    images: ["/image/placeholder-project.png"],
    alts: ["JobSearch.AI platform preview"],
    live: "https://job-search-ai-ten.vercel.app/",
    github: "https://github.com/tech00exploere/JobSearch.AI",
  }
];
